    ...
    <>
      ...
      <section className="py-24 lg:py-36">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl sm:text-4xl leading-[1.15] tracking-tight text-[#1c1c1c] mb-8">
            We find the vulnerabilities<br />
            before the public does.
          </h1>
          <p className="text-lg text-[#3d3d3d] leading-relaxed max-w-xl mb-10">
      ...
      <hr className="border-[#e8e8e4] mx-auto max-w-3xl" />

      {/* Methodology */}
      <section className="py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl text-[#1c1c1c] mb-10">Methodology</h2>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-sm text-[#3d3d3d] leading-relaxed mb-6 max-w-xl">
          ...
          <Link
            href="/analysis"
            className="inline-flex items-center gap-1.5 text-sm font-medium text-[#1c1c1c] hover:text-[#3d3d3d] transition-colors"
          >
      ...
      <section className="py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl text-[#1c1c1c] mb-5">Reach</h2>
          <p className="text-sm text-[#3d3d3d] leading-relaxed max-w-xl">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-sm text-[#3d3d3d] leading-relaxed max-w-xl mb-6">
