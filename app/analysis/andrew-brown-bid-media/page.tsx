...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.siba.digital/analysis/andrew-brown-bid-media",
  },
  openGraph: {
    ...
    url: "https://www.siba.digital/analysis/andrew-brown-bid-media",
    type: "article",
  },
};
...
const articleSchema = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://www.siba.digital/analysis/andrew-brown-bid-media",
  },
};
          ...
          <div className="mt-6 space-y-3">
            {[
              ...
              },
              {
                ...
                body: "Includes a Treasurer who is an active director of Mikhail Hotels and Leisure Holdings Limited on Companies House. No termination has been filed.",
                highlight: true,
                link: { label: "Read BID Treasurer analysis", href: "/analysis/bid-treasurer-mikhail" },
              },
              {
                step: "03",
